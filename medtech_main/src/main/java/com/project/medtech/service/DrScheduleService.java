...
public class DrScheduleService {
    ...
    //checks if the days are free of a certain month
    ...
    public List<ReservedDateDTO> reservedDates(Long pID, Long drID, Date date) {
        ...
        for (int i = 1; i < daysInMonth + 1; i++) {
            ...
            int num2 = 0;
            try {
                for (ReservedDayDTO reservedDayDTO : getGetAllReservedTimeDate(pID, drID, new Date(date.getYear(), date.getMonth(), i))) {
            ...
            if (num > 0) {
                rdate.add(new ReservedDateDTO(Colors.RED, new Date(date.getYear(), date.getMonth(), i), getGetAllReservedTimeDate(pID, drID, new Date(date.getYear(), date.getMonth(), i))));

            } else if (num2 == getGetAllReservedTimeDate(pID, drID, new Date(date.getYear(), date.getMonth(), i)).size()) {
                rdate.add(new ReservedDateDTO(Colors.BLUE, new Date(date.getYear(), date.getMonth(), i), getGetAllReservedTimeDate(pID, drID, new Date(date.getYear(), date.getMonth(), i))));
            } else {
                rdate.add(new ReservedDateDTO(Colors.GRAY, new Date(date.getYear(), date.getMonth(), i), getGetAllReservedTimeDate(pID, drID, new Date(date.getYear(), date.getMonth(), i))));
            }
    ...
    //Show all Schedules By DoctorID
    ...
    public DrScheduleDTO save(DrScheduleDTO dto) {
        ...
        DrScheduleDTO dto1 = DrScheduleMapper.EntityToDto(doctorSchedule);
        return dto1;
    }
