...
public class DoctorScheduleController {
    ...
    @ApiOperation(value = " получения расписания определенного доктора и пациента по определенной дате (Флаттер)")
    ...
    @ApiOperation(value = " получения расписания определенного доктора и пациента по определенной дате (Веб)")
    ...
    @ApiOperation(value = " получения будущих приёмов которые запланировались но еще прошли по id пациента (Флатер)")
